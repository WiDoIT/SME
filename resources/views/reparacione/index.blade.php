                                ...
                                <tbody>
                                    @foreach ($reparaciones as $reparacione)
                                        <tr>
											...
											<td>{{ $reparacione->start }}</td>
											<td>{{ $reparacione->end }}</td>
											<td>{{ $reparacione->tecnico_id }} {{$reparacione->tecnico->nombre}}</td>
											<td>{{ $reparacione->maquina_id }} {{$reparacione->maquina->nombre}}</td>
